...
\begin{titlepage}
	...
	\begin{minipage}[t]{0.16\textwidth}
		{\large \textbf{Co-relatori:}}
	\end{minipage}
	\begin{minipage}[t]{0.84\textwidth}
		{\large \textit{Dott. Simone Spolaor\\Dott. Marco S. Nobile}}
	\end{minipage}
...
%   NON-CONTENT PAGES
%-------------------------------------------------------------------------------
\Quotation{We can only see a short distance ahead, but we can see plenty 
...
% Dedication text
\Dedicatory{Alla mia famiglia, ai miei amici e a tutte le persone grazie alle
quali sono giunto alla fine di questo percorso}

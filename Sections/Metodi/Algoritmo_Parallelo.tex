...
e $\frac{\psi_{i}}{1024}$ Thread Block,
in modo tale che ognuno di essi si occupi di generare una cellula avente
$\varphi_{i}$ valore di fluorescenza.
\\
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
...
bounding presenta meno nodi, ciò equivale al fatto di risparmiare
...
Nel grafico in figura \ref{chart:bounding-inference} si può notare un maggiore
...
di prestazioni poichè la GPU utilizzata non ha abbastanza memoria per istanziare

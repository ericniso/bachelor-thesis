...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[legend pos=outer north east,
            ...
            \addplot table {Data/python.txt};
            \addplot table {Data/Accelerants/original.txt};
            \legend{Python,CUDA}
        \end{axis}
    \end{tikzpicture}
    \caption{}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[legend pos=outer north east,
            ...
            \addplot table {Data/Accelerants/original.txt};
            \addplot table {Data/Accelerants/dynamic_parallelism.txt};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[legend pos=outer north east,
            ...
            \addplot table {Data/Accelerants/dynamic_parallelism.txt};
            \addplot table {Data/Accelerants/bounding.txt};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[legend pos=outer north east,
            ...
            \addplot table {Data/Accelerants/bounding.txt};
            \addplot table {Data/Accelerants/inference.txt};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[legend pos=outer north east,
            ...
            \addplot table {Data/Accelerants/inference.txt};
            \addplot table {Data/Accelerants/histogram.txt};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[legend pos=north west,
            ...
            \addplot table {Data/Memory/original.txt};
            \addplot table {Data/Memory/histogram.txt};

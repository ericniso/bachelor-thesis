...
\begin{figure}[H]
    \begin{minipage}[b]{.5\linewidth}
        ...
        \\
        $\varphi_{min}=11.0, \tau_{max}=240$ ore}
    \end{minipage}
    \begin{minipage}[b]{.5\linewidth}
        \centering
        \scalebox{0.65}{
        ...
        \subcaption{Confronto simulazioni Python e CUDA con
        \\
        $\varphi_{min}=8.7, \tau_{max}=504$ ore}
    \end{minipage}
    \begin{minipage}[b]{.5\linewidth}
        \vspace{0.3cm}
        \centering
        ...
        \subcaption{Confronto fra i dati sperimentalie la simulazione
        \\
        CUDA con $\varphi_{min}=11.0, \tau_{max}=240$ ore}
    \end{minipage}
    \begin{minipage}[b]{.5\linewidth}
        \vspace{0.3cm}
        \centering
        ...
        \subcaption{Confronto fra i dati sperimentali e la simulazione
        \\
        CUDA con $\varphi_{min}=8.7, \tau_{max}=504$ ore}
    \end{minipage}

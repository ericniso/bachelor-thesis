...
\begin{figure}[H]
    \begin{minipage}[b]{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \addplot+[ybar interval,mark=no] table {Data/Final/fit_cuda.txt};
            \addplot+[ybar interval,mark=no] table {Data/Final/fit_cpu.txt};
            \legend{CUDA, Python}
        \end{axis}
        \end{tikzpicture}
        }
    ...
    \begin{minipage}[b]{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \addplot+[ybar interval,mark=no] table
                {Data/Final/validation_cuda.txt};
            \addplot+[ybar interval,mark=no] table
                {Data/Final/validation_cpu.txt};
                \legend{CUDA, Python}
        \end{axis}
        \end{tikzpicture}
        }
    ...
    \begin{minipage}[b]{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \addplot+[ybar interval,mark=no] table {Data/Final/fit_cuda.txt};
            \addplot+[ybar interval,mark=no] table {Data/Final/fit_target.txt};
    ...
    \begin{minipage}[b]{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \addplot+[ybar interval,mark=no] table
                {Data/Final/validation_cuda.txt};
            \addplot+[ybar interval,mark=no] table
                {Data/Final/validation_target.txt};
            \legend{CUDA, Laboratorio}
        \end{axis}
        \end{tikzpicture}
        }
